  ...
  source: {
    ...
    define: {
      'process.env': {
        ...
        // Exact redirect URI registered in the Deriv OAuth app settings.
        // Must match character-for-character (no trailing slash, correct scheme).
        NEXT_PUBLIC_REDIRECT_URI: JSON.stringify(process.env.NEXT_PUBLIC_REDIRECT_URI ?? ''),
